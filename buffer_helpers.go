...
type bufferHelper interface {
	...
	GetBytes(index int, p []byte) error
...
func (b *wrappedBuffer) WriteString(s string) error {
...
func (b *wrappedBuffer) WriteByte(b2 byte) error {
	return b.WriteBytes([]byte{b2})
}

func (b *wrappedBuffer) GetByte(index int) (byte, error) {
	p := make([]byte, 1)
	if err := b.GetBytes(index, p); err != nil {
		return 0, err
	}
...
func (b *wrappedBuffer) SetByte(index int, b2 byte) error {
	return b.SetBytes(index, []byte{b2})
}
...
func (b *wrappedBuffer) ReadUint16() (uint16, error) {
	...
	return uint16(binary.BigEndian.Uint16(p)), nil
}
...
func (b *wrappedBuffer) ReadUint16LE() (uint16, error) {
	...
	return uint16(binary.LittleEndian.Uint16(p)), nil
}
...
func (b *wrappedBuffer) ReadUint32() (uint32, error) {
	...
	return uint32(binary.BigEndian.Uint32(p)), nil
}
...
func (b *wrappedBuffer) ReadUint32LE() (uint32, error) {
	...
	return uint32(binary.LittleEndian.Uint32(p)), nil
}
...
func (b *wrappedBuffer) ReadUint64LE() (uint64, error) {
	...
	return uint64(binary.LittleEndian.Uint64(p)), nil
}
